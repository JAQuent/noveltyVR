...
c) You also need to have the correct libs installed see libs chunk.-->
...
path2parent <- "C:/Users/admin/Documents/GitHub/noveltyVR" # This need to be changed to run this document
######################################################
```
...
library(chron)
library(BayesFactor)
library(assortedRFunctions) # use devtools::install_github("JAQuent/assortedRFunctions", upgrade = 'never')
